...
function slideBar() {
	...
	if (scoreboardSlideTriggerLeft || scoreboardSlideTriggerRight)
	{
	  ...
	  // Next, the function checks if sliding left is available.
	  if (scoreboardX <= scoreboardStartX - 1664 + (window.innerWidth - 360))
	  {
...
function adjustPage() {
	...
	{
		document.getElementById("pagebartext").style.left = ((window.innerWidth) / 2) - 322 + "px";	
	}
	else
	{
